...
$show_action = $_GET['action'];
    ...
    $response = "<table border='1' width='95%'><tr><th width='170'>Date/Heure</th><th width='100'>Type</th><th>D&eacute;signation</th><th width='50'>Agent</th><th width='50'>Actions</th><th width='170'>Mise à jour le</th></tr>";
